!function (t) {
    ...
    1: function (t, e) {
        ...
        var r = n(1), o = n(7), a = n(11), i = n(18)("src"), s = Function.toString, c = ("" + s).split("toString");
        n(16).inspectSource = function (t) {
            return s.call(t)
        }, (t.exports = function (t, e, n, s) {
            var l = "function" == typeof n;
            l && (a(n, "name") || o(n, "name", e)), t[e] !== n && (l && (a(n, i) || o(n, i, t[e] ? "" + t[e] : c.join(String(e)))), t === r ? t[e] = n : s ? t[e] ? t[e] = n : o(t, e, n) : (delete t[e], o(t, e, n)))
        })(Function.prototype, "toString", function () {
            return "function" == typeof this && this[i] || s.call(this)
        })
    }, 14: function (t, e, n) {
        var r = n(1), o = n(16), a = n(7), i = n(12), s = n(26), c = function (t, e, n) {
            var l, u, f, p, m = t & c.F, g = t & c.G, S = t & c.S, v = t & c.P, y = t & c.B,
                d = g ? r : S ? r[e] || (r[e] = {}) : (r[e] || {}).prototype, F = g ? o : o[e] || (o[e] = {}),
                h = F.prototype || (F.prototype = {});
            for (l in g && (n = e), n) f = ((u = !m && d && void 0 !== d[l]) ? d : n)[l], p = y && u ? s(f, r) : v && "function" == typeof f ? s(Function.call, f) : f, d && i(d, l, f, t & c.U), F[l] != f && a(F, l, p), v && h[l] != f && (h[l] = f)
        };
        r.core = o, c.F = 1, c.G = 2, c.S = 4, c.P = 8, c.B = 16, c.W = 32, c.U = 64, c.R = 128, t.exports = c
    }, 15: function (t, e, n) {
        for (var r = n(27), o = n(32), a = n(12), i = n(1), s = n(7), c = n(24), l = n(3), u = l("iterator"), f = l("toStringTag"), p = c.Array, m = {
            CSSRuleList: !0,
            ...
            TextTrackList: !1,
            TouchList: !1
        }, g = o(m), S = 0; S < g.length; S++) {
            var v, y = g[S], d = m[y], F = i[y], h = F && F.prototype;
            if (h && (h[u] || s(h, u, p), h[f] || s(h, f, y), c[y] = p, d)) for (v in r) h[v] || a(h, v, r[v], !0)
        }
    }, 16: function (t, e) {
        ...
        var r = n(5), o = n(1).document, a = r(o) && r(o.createElement);
        t.exports = function (t) {
        ...
        "use strict";
        var r = n(40), o = n(49), a = n(24), i = n(19);
        ...
        var r = n(34)("wks"), o = n(18), a = n(1).Symbol, i = "function" == typeof a;
        (t.exports = function (t) {
        ...
        var r = n(34)("keys"), o = n(18);
        t.exports = function (t) {
            return r[t] || (r[t] = o(t))
        }
    }, 34: function (t, e, n) {
        var r = n(16), o = n(1), a = o["__core-js_shared__"] || (o["__core-js_shared__"] = {});
        (t.exports = function (t, e) {
        ...
        var r = n(9).f, o = n(11), a = n(3)("toStringTag");
        t.exports = function (t, e, n) {
        ...
        var r = n(6), o = n(57), a = n(37), i = n(33)("IE_PROTO"), s = function () {
        }, c = function () {
            var t, e = n(25)("iframe"), r = a.length;
            for (e.style.display = "none", n(51).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), c = t.F; r--;) delete c.prototype[a[r]];
            return c()
        };
        t.exports = Object.create || function (t, e) {
            var n;
            return null !== t ? (s.prototype = r(t), n = new s, s.prototype = null, n[i] = t) : n = c(), void 0 === e ? n : o(n, e)
        }
    }, 46: function (t, e, n) {
        var r = n(11), o = n(19), a = n(50)(!1), i = n(33)("IE_PROTO");
        t.exports = function (t, e) {
            var n, s = o(t), c = 0, l = [];
        ...
        "use strict";
        var r = n(31), o = n(14), a = n(12), i = n(7), s = n(24), c = n(56), l = n(38), u = n(58), f = n(3)("iterator"),
            p = !([].keys && "next" in [].keys()), m = function () {
                return this
            };
        t.exports = function (t, e, n, g, S, v, y) {
            c(n, e, g);
            var d, F, h, O = function (t) {
                ...
                }, b = e + " Iterator", L = "values" == S, k = !1, M = t.prototype,
                E = M[f] || M["@@iterator"] || S && M[S], T = E || O(S), I = S ? L ? O("entries") : T : void 0,
                x = "Array" == e && M.entries || E;
            if (x && (h = u(x.call(new t))) !== Object.prototype && h.next && (l(h, b, !0), r || "function" == typeof h[f] || i(h, f, m)), L && E && "values" !== E.name && (k = !0, T = function () {
                return E.call(this)
            }), r && !y || !p && !k && M[f] || i(M, f, T), s[e] = T, s[b] = m, S) if (d = {
                values: L ? T : O("values"),
                keys: v ? T : O("keys"),
                entries: I
            }, y) for (F in d) F in M || a(M, F, d[F]); else o(o.P + o.F * (p || k), e, d);
            return d
        }
    }, 48: function (t, e, n) {
        var r = n(23), o = Math.max, a = Math.min;
        t.exports = function (t, e) {
        ...
        var r = n(19), o = n(21), a = n(48);
        t.exports = function (t) {
            return function (e, n, i) {
                var s, c = r(e), l = o(c.length), u = a(i, l);
                if (t && n != n) {
        ...
        "use strict";
        var r = n(45), o = n(22), a = n(38), i = {};
        n(7)(i, n(3)("iterator"), function () {
            return this
        }), t.exports = function (t, e, n) {
            t.prototype = r(i, {next: o(1, n)}), a(t, e + " Iterator")
        }
    }, 57: function (t, e, n) {
        var r = n(9), o = n(6), a = n(32);
        ...
        var r = n(11), o = n(20), a = n(33)("IE_PROTO"), i = Object.prototype;
        ...
        n(15), n(27), n(15), n(27), function (t) {
            t.fn.tkVectorWorldMapGDP = function () {
                ...
                this.length && this.vectorMap({
                    ...
                    markers: [{latLng: [41.9, 12.45], name: "Vatican City"}, {
                        ...
                        latLng: [-20.2, 57.5],
                        name: "Mauritius"
                    }, {latLng: [26.02, 50.55], name: "Bahrain"}, {latLng: [.33, 6.73], name: "So Tom and Prncipe"}]
                })
                ...
                if (this.length) {
                    var t = new jvm.Map({
                        ...
                        backgroundColor: "#fff",
                        zoomOnScroll: !1,
                        markers: [{latLng: [52.5, 13.39], name: "Berlin"}, {
                            latLng: [53.56, 10],
                            name: "Hamburg"
                            ...
                            latLng: [51.51, 7.46],
                            name: "Dortmund"
                        }, {latLng: [51.45, 7.01], name: "Essen"}, {latLng: [53.07, 8.8], name: "Bremen"}],
                        markerStyle: {
                            initial: {fill: settings.colors.primary[300]},
                            selected: {fill: settings.colors.success[500]}
                        },
                        regionStyle: {
                            initial: {fill: settings.colors.primary[500]},
                            selected: {fill: settings.colors.gray[700]}
                        },
                        series: {
                            markers: [{
                                attribute: "r",
                ...
                this.length && t.getJSON("assets/data/vector-maps/data/france-elections.json", function (e) {
                    new jvm.Map({
                        map: "fr_merc_en",
                        backgroundColor: "#fff",
                        ...
                        series: {
                            regions: [{
                                scale: {1: settings.colors.primary[500], 2: settings.colors.primary[300]},
                                attribute: "fill",
            ...
            t.fn.tkVectorRandomColors = function () {
                ...
                if (this.length) {
                    ...
                    (e = new jvm.Map({
                        ...
                        var a = e.pointToLatLng(o.offsetX, o.offsetY), i = t(o.target).attr("class");
                        a && (!i || i && -1 === t(o.target).attr("class").indexOf("jvectormap-marker")) && (r[n] = a, e.addMarker(n, {latLng: [a.lat, a.lng]}), n += 1)
                    })
                }
        ...
        var r = n(6), o = n(36), a = n(29), i = Object.defineProperty;
